...
CREATE TABLE PollOption (
  ...
  label TEXT NOT NULL,
  createdAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (pollId) REFERENCES DailyPoll(id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE RoutePoint (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  routeKey TEXT NOT NULL DEFAULT 'uniguajira-riohacha',
  title TEXT NOT NULL,
  description TEXT,
  lat REAL NOT NULL,
  lng REAL NOT NULL,
